...
def findshelf():
    global toward
    xd = [-1.32,-0.84,1.32,0.84]
    yd = [0.84,-1.32,-0.84,1.16]
    simplego(0.84,1.32)
    for j in range(4):
        for i in range(7):
            go_forward(0.26)
...
class Matter(object):
    pass
model = Matter()
xmid = [-1.1,-1.1,1.1,1.1]
ymid = [0.48,-0.48,-0.48,0.48]

xfin = [-1.37,-1.37,1.37,1.37]
yfin = [0.48,-0.48,-0.48,0.48]
# 状态定义
    ...
    if (model.state == "raozhuzou"):
        ...
        if(camera1.getRecognitionObjects()):
            ...
            if (gotcolor == 0.1):
                ...
                if(toward%2==0):
                    print("here")
                    simplego(xobject-0.151*(-t+1),yobject+(0.336+lengthobject[1]*0.5)*(-t+1))
                    grip()
                    ...
                    print("here1")
                    simplego(yobject-0.151*(-t+2),xobject-(0.336+lengthobject[1]*0.5)*(-t+2))
                    grip()
                    go_rl(-0.26)
                    setarm(1.61,1.5,1.5,-1.5,0,1)
                    model.getobject()
                ...
                t = toward
                if(toward%2==0):
                    simplego(xobject-0.151*(-t+1),yobject+(0.336+lengthobject[2])*(-t+1))
                    grip()
                    go_rl(-0.26)#上面的抓取好像自己抬手了，缩合抓手之后向右动固定距离（下面此处没加，有必要的话加上）
                    setarm(1.61,1.5,1.5,-1.5,0,1)
                    model.getobject()
              
                else:
                    simplego(yobject-0.151*(-t+2),xobject-(0.336+lengthobject[2])*(-t+2))
                    grip()
                    setarm(1.61,1.5,1.5,-1.5,0,1)
                    model.getobject()
                ...
                t = toward
                if(toward%2==0):
                    simplego(xobject-0.151*(-t+1),yobject+(0.336+lengthobject[3])*(-t+1))
                    grip()
                    setarm(1.61,1.5,1.5,-1.5,0,1)
                    model.getobject()
               
                else:
                    simplego(yobject-0.151*(-t+2),xobject-(0.336+lengthobject[3])*(-t+2))
                    grip()
                    setarm(1.61,1.5,1.5,-1.5,0,1)
                    model.getobject()
                ...
                t = toward
                if(toward%2==0):
                    simplego(xobject-0.151*(-t+1),yobject+(0.336+lengthobject[4])*(-t+1))
                    grip()
                    setarm(1.61,1.5,1.5,-1.5,0,1)
                    model.getobject()
                
                else:
                    simplego(yobject-0.151*(-t+2),xobject-(0.336+lengthobject[4])*(-t+2))
                    grip()
                    setarm(1.61,1.5,1.5,-1.5,0,1)
                    model.getobject()
                ...
                t = toward
                if(toward%2==0):
                    simplego(xobject-0.151*(-t+1),yobject+(0.336+lengthobject[5])*(-t+1))
                    grip()
                    setarm(1.61,1.5,1.5,-1.5,0,1)
                    model.getobject()
                  
                else:
                    simplego(yobject-0.151*(-t+2),xobject-(0.336+lengthobject[5])*(-t+2))
                    grip()
                    setarm(1.61,1.5,1.5,-1.5,0,1)
                    model.getobject()
                ...
                t = toward
                if(toward%2==0):
                    simplego(xobject-0.151*(-t+1),yobject+(0.336+lengthobject[6])*(-t+1))
                    grip()
                    setarm(1.61,1.5,1.5,-1.5,0,1)
                    model.getobject()
                    
                else:
                    simplego(yobject-0.151*(-t+2),xobject-(0.336+lengthobject[6])*(-t+2))
                    grip()
                    setarm(1.61,1.5,1.5,-1.5,0,1)
                    model.getobject()
                ...
                t = toward
                if(toward%2==0):
                    simplego(xobject-0.151*(-t+1),yobject+(0.336+lengthobject[7]*0.5)*(-t+1))
                    grip()
                    setarm(1.61,1.5,1.5,-1.5,0,1)
                    model.getobject()
                   
                else:
                    simplego(yobject-0.151*(-t+2),xobject-(0.336+lengthobject[7]*0.5)*(-t+2))
                    grip()
                    setarm(1.61,1.5,1.5,-1.5,0,1)
                    model.getobject()
                ...
                t = toward
                if(toward%2==0):
                    simplego(xobject-0.151*(-t+1),yobject+(0.336+lengthobject[8]*0.5)*(-t+1))
                    grip()
                    go_rl(-0.26)
                    print("here")
                    setarm(1.61,1.5,1.5,-1.5,0,1)
                    ...
                    simplego(yobject-0.151*(-t+2),xobject-(0.336+lengthobject[8]*0.5)*(-t+2))
                    grip()
                    go_rl(-0.26)
                    setarm(1.61,1.5,1.5,-1.5,0,1)
                    model.getobject()
                ...
                t = toward
                if(toward%2==0):
                    simplego(xobject-0.151*(-t+1),yobject+(0.336+lengthobject[0])*(-t+1))
                    grip()
                    setarm(1.61,1.5,1.5,-1.5,0,1)
                    model.getobject()
               
                else:
                    simplego(yobject-0.151*(-t+2),xobject-(0.336+lengthobject[0])*(-t+2))
                    grip()
                    setarm(1.61,1.5,1.5,-1.5,0,1)
                    model.getobject()
